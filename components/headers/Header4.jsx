      ...
      <header id="header" className="header-default header-style-2">
        <div className="main-header line">
          <div
            ...
            className="container-full px_15 lg-px_40"
          >
                  ...
                  <ul className="tf-social-icon d-flex gap-10">
                    <li>
                      <a
                        ...
                        target="_blank"
                        className="box-icon w_34 round social-facebook social-line text-white border-white"
                      >
                    ...
                    <li>
                      <a
                        ...
                        target="_blank"
                        className="box-icon w_34 round social-instagram social-line text-white border-white"
                      >
              ...
              <div className="col-xl-5 col-md-4 col-3">
                <ul className="nav-icon d-flex justify-content-end align-items-center gap-20">
                  ...
                  <li className="nav-account">
                    <UserIcon onOpenLogin={() => setActiveAuthModal("login")} />
                  </li>
                  <li className="nav-cart ">
                    ...
                    >
                      <i className="icon icon-bag text-white" />
